...
$(document).ready(function() {
    ...
    function onClickity() {
        $pickOne = $('.slot-one').find('.focus');
        $pickTwo = $('.slot-two').find('.focus');
        $pickThree = $('.slot-three').find('.focus');
        console.log($pickOne.hasClass('focus'));
    }
    onClickity(); 
    $(".hero-unit").hover(function() {
        $(".down-two").animate({'marginTop': "+=80px"}, "medium");
        $(".down-one").animate({'marginTop': "+=160px"}, "medium");
        $(".generate").animate({'marginTop': "+=160px"}, "medium");
    }, function() {
        $(".down-two").animate({'marginTop': "-=80px"}, "medium");
        $(".down-one").animate({'marginTop': "-=160px"}, "medium");
        $(".generate").animate({'marginTop': "-=160px"}, "medium");
    ...
    $(".button").click(function() {
        if (($(this).parent().hasClass('option-one'))) {
            $('.slot-one').find('.focus').removeClass('focus');
        }
        else if (($(this).parent().hasClass('option-two'))) {
            $('.slot-two').find('.focus').removeClass('focus');
        }
        else if (($(this).parent().hasClass('option-three'))) {
            $('.slot-three').find('.focus').removeClass('focus');
        }
        $(this).addClass('focus');
        onClickity();
    });
    ...
    $(".generate").click(function() {
        var strOne = $('.slot-one').find('.focus').html();
        var strTwo = $('.slot-two').find('.focus').html();
        var strThree = $('.slot-three').find('.focus').html();
