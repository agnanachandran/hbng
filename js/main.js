var words = {
    ...
    Verb:["Creeping", "Crawling", "Walking", "Running", "Jumping", "Skipping", "Hoping", "Slithering", "Climbing", "Digging", "Squirming", "Flying", "Sitting", "Stalking", "Stomping", "Tiptoeing", "Galloping", "Blowing", "Dancing", "Gliding", "Swimming", "Washing", "Playing", "Throwing", "Drinking", "Eating", "Chewing", "Singing", "Shouting", "Growling", "Barking", "Buzzing", "Laughing", "Smiling", "Crying", "Mooing", "Quacking", "Talking", "Yelling", "Screaming", "Screeching", "Squawking", "Squealing", "Glowing", "Listening", "Painting", "Looking", "Reading", "Knitting", "Sleeping", "Drawing", "Shining", "Watching", "Kicking", "Diving", "Finding", "Building", "Working", "Exploring", "Shopping", "Cleaning", "Catching", "Shaking"],
